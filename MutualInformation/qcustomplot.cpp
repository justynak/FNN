...
/*! \overload
  ...
  smallest vector.
*/
void QCPGraph::setData(const QList<double> &key, const QList<double> &value)
{
  mData->clear();
  int n = key.size();
  n = qMin(n, value.size());
...
*/
void QCPGraph::setDataValueError(const QList<double> &key, const QList<double> &value, const QList<double> &valueError)
{
  mData->clear();
  int n = key.size();
  n = qMin(n, value.size());
...
/*!
  ...
  smallest vector.
*/
void QCPGraph::setDataValueError(const QList<double> &key, const QList<double> &value, const QList<double> &valueErrorMinus, const QList<double> &valueErrorPlus)
{
  mData->clear();
  int n = key.size();
  n = qMin(n, value.size());
...
/*!
  ...
  For asymmetrical errors (plus different from minus), see the overloaded version of this function.
*/
void QCPGraph::setDataKeyError(const QList<double> &key, const QList<double> &value, const QList<double> &keyError)
{
  mData->clear();
  int n = key.size();
  n = qMin(n, value.size());
...
/*!
  ...
  smallest vector.
*/
void QCPGraph::setDataKeyError(const QList<double> &key, const QList<double> &value, const QList<double> &keyErrorMinus, const QList<double> &keyErrorPlus)
{
  mData->clear();
  int n = key.size();
  n = qMin(n, value.size());
...
/*!
  ...
  For asymmetrical errors (plus different from minus), see the overloaded version of this function.
*/
void QCPGraph::setDataBothError(const QList<double> &key, const QList<double> &value, const QList<double> &keyError, const QList<double> &valueError)
{
  mData->clear();
  int n = key.size();
  n = qMin(n, value.size());
...
/*!
  ...
  smallest vector.
*/
void QCPGraph::setDataBothError(const QList<double> &key, const QList<double> &value, const QList<double> &keyErrorMinus, const QList<double> &keyErrorPlus, const QList<double> &valueErrorMinus, const QList<double> &valueErrorPlus)
{
  mData->clear();
  int n = key.size();
  n = qMin(n, value.size());
