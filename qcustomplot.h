...
public:
  ...
  */
  ...
  void setData(const QList<double> &key, const QList<double> &value);
  void setDataKeyError(const QList<double> &key, const QList<double> &value, const QList<double> &keyError);
  void setDataKeyError(const QList<double> &key, const QList<double> &value, const QList<double> &keyErrorMinus, const QList<double> &keyErrorPlus);
  void setDataValueError(const QList<double> &key, const QList<double> &value, const QList<double> &valueError);
  void setDataValueError(const QList<double> &key, const QList<double> &value, const QList<double> &valueErrorMinus, const QList<double> &valueErrorPlus);
  void setDataBothError(const QList<double> &key, const QList<double> &value, const QList<double> &keyError, const QList<double> &valueError);
  void setDataBothError(const QList<double> &key, const QList<double> &value, const QList<double> &keyErrorMinus, const QList<double> &keyErrorPlus, const QList<double> &valueErrorMinus, const QList<double> &valueErrorPlus);
